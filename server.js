...
const ID = process.env.REQUIRED_ID;
...
app.get("/", async (request, reply) => {
    return reply.send("Site is under construction. Check the disk link: [ССЫЛКА]");
});
...
app.get(REQUEST_ROUTE, async (request, reply) => {
    const id = request.headers[HEADER];
